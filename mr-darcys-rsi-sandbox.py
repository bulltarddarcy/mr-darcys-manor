                ...
                if df is None or df.empty:
                    ...
                    if not all([date_col, close_col]):
                        ...
                        for p in periods:
                            ...
                            ev_val = avg_ret # Requested same as Avg Ret
                        ...
                        with c_right:
                            if matches.empty:
                                ...
                                st.dataframe(
                                    res_df.style
                                    .format({"Win Rate": format_func, "Avg Ret": format_func, "EV": format_func})
                                    .map(highlight_ret, subset=["Avg Ret", "EV"])
    ...
    with tab_div:
        ...
        with st.expander("ℹ️ Page Notes: Divergence Strategy Logic"):
            ...
            with f_col2:
                ...
                st.markdown(f"""
                * **Signal-Based**: The system finds every matching historical signal (e.g. every Bullish Divergence in history).
